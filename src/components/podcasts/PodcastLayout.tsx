      ...
      {!isConfigured ? (
        <div className="max-w-2xl mx-auto p-6">
          <div className="glass-card p-6">
            <h2 className="text-2xl font-semibold mb-6">Podcast Configuration</h2>
            <Progress value={progress} className="mb-8" />
            
            <div className="space-y-6">
              {currentStep === 1 && (
                <div className="animate-fadeIn">
                  <h3 className="text-xl mb-4">Step 1: Basic Information</h3>
                  <p className="text-gray-400">Configure your podcast details...</p>
                </div>
              )}
              {currentStep === 2 && (
                <div className="animate-fadeIn">
                  <h3 className="text-xl mb-4">Step 2: Cover Art</h3>
                  <p className="text-gray-400">Upload your podcast cover art...</p>
                </div>
              )}
              {currentStep === 3 && (
                <div className="animate-fadeIn">
                  <h3 className="text-xl mb-4">Step 3: Distribution</h3>
                  <p className="text-gray-400">Set up your distribution channels...</p>
                </div>
              )}
              {currentStep === 4 && (
                <div className="animate-fadeIn">
                  <h3 className="text-xl mb-4">Step 4: Analytics</h3>
                  <p className="text-gray-400">Configure your analytics preferences...</p>
                </div>
              )}
              {currentStep === 5 && (
                <div className="animate-fadeIn">
                  <h3 className="text-xl mb-4">Step 5: Review</h3>
